    ...
    If SpaceObject(X, 0) = 1 And SpaceObject(X, 8) = 1 Then
        ...
        For Z = X + 1 To MaxObjects
            ...
            If SpaceObject(Z, 0) = 1 And SpaceObject(Z, 8) = 1 Then
                ...
                If (SpaceObject(X, 1) - SpaceObject(Z, 1)) > Form1.Picture1.Width / 2 Then
                    ScreenModXX = -Form1.Picture1.Width
                ElseIf (SpaceObject(Z, 1) - SpaceObject(X, 1)) > Form1.Picture1.Width / 2 Then
                    ScreenModZX = -Form1.Picture1.Width
                End If
                
                If (SpaceObject(X, 2) - SpaceObject(Z, 2)) > Form1.Picture1.Height / 2 Then
                    ScreenModXY = -Form1.Picture1.Height
                ElseIf (SpaceObject(Z, 2) - SpaceObject(X, 2)) > Form1.Picture1.Height / 2 Then
                    ScreenModZY = -Form1.Picture1.Height
                End If
                If X = 0 And Z = 5 Then
                    X = X
                End If
